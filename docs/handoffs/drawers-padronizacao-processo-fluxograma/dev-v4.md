# Dev Handoff: Padronização de Drawers (Footer Cargo Fixo)
...
- Footer do drawer de Cargo fixado no fundo com comportamento sticky e body flexível.

## 2️⃣ Arquivos Criados/Alterados

### Frontend
- frontend/src/app/views/pages/cockpit-pilares/matriz-cargos-funcoes/cargo-form-drawer/cargo-form-drawer.component.ts - ajustes de flex e `position: sticky` no footer.
...
- **Prioridade de testes:** UI do drawer de Cargo.
