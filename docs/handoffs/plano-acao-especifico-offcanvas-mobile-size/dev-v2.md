# Dev Handoff: Plano de Ação Específico - Offcanvas Mobile Maior (Correção TS)
...
- Correção de tipagem TypeScript para `panelClass` no offcanvas.

## 2️⃣ Arquivos Criados/Alterados

### Frontend
- frontend/src/app/views/pages/cockpit-pilares/plano-acao-especifico/plano-acao-especifico.component.ts - `panelClass` em string única.

## 3️⃣ Decisões Técnicas

- Uso de string com classes separadas por espaço para compatibilidade com tipagem do ng-bootstrap.
