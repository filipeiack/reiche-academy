...
test.describe('LEGACY: Dashboard Cockpit @cockpit @regression @high @legacy', () => {
...
test.describe('LEGACY: Dashboard Cockpit - Componentes Filhos @cockpit @legacy', () => {
  test.beforeEach(async ({ page }) => {
    // Login primeiro
    await page.goto('/login');
    await page.fill('input[formControlName="email"]', 'gestor@empresa-a.com');
...
test.describe('LEGACY: Dashboard Cockpit - Performance @cockpit @legacy', () => {
