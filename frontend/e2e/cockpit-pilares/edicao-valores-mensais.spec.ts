...
test.describe('LEGACY: Edição de Valores Mensais @cockpit @indicadores @high @legacy', () => {
...
test.describe('LEGACY: Edição de Valores Mensais - Estados de Erro @cockpit @indicadores @high @legacy', () => {
...
test.describe('LEGACY: Edição de Valores Mensais - Responsividade @cockpit @indicadores @high @legacy', () => {
